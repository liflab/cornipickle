...
public class PredicateVariable extends LogicalExpression<NamedDomain> 
{
	...
	public PredicateVariable(String name, String ... operand_names)
	{
		super();
	...
	public PredicateVariable(PredicateVariable in)
	{
		super();
	...
	public PredicateVariable setValue(String var_name, Object value)
	{
	...
	@Override
	public PredicateVariable getCopy()
	{
