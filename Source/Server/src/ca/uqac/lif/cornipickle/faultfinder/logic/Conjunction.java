...
public class Conjunction<T> extends NaryConnective<T> 
{
	@SafeVarargs
	public Conjunction(LogicalExpression<T> ... exps)
	{
		super(exps);
	}
	
	public Conjunction(Conjunction<T> c)
	{
		super(c);
	}
	...
	@Override
	public Conjunction<T> getCopy()
	{
		return new Conjunction<T>(this);
	}
