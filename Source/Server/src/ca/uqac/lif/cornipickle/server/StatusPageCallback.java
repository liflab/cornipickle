...
class StatusPageCallback extends InterpreterCallback
{
	...
	public CallbackResponse process(HttpExchange t)
	{
		...
		if (m_server.getLastProbeContact() != null)
			page.append("<script type=\"text/javascript\">probe_last_contact=" + (m_server.getLastProbeContact().getTime()) + ";</script>");
	...
	protected void createProbeContactMessage(Date last_contact, StringBuilder page)
	{
