...
* </ul>
*/
class GetProbeFeedback extends InterpreterCallback
{
/**
...
public GetProbeFeedback(Interpreter i, String server_name, int server_port)
{
	this(i, server_name, server_port, false);
}

public GetProbeFeedback(Interpreter i, String server_name, int server_port, boolean minify)
{
	super(i, RequestCallback.Method.GET, "/probefeedback");
...
{
	return PackageFileReader.readPackageFile(CornipickleServer.class, "resource/probefeedback.inc.js");
}
